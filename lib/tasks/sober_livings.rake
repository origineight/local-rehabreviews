namespace :sober_livings do

  desc "This task creates the Sober Livings directory and imports the data from CSV"
  task :import => :environment do
    dir = Directory.find_or_create_by(:name => "Sober Livings")

    url = "http://rehab-reviews.s3.amazonaws.com/assets/sober_living.json"
    ...
    data.each_with_index do |obj,i|
      ...
      l.save!
      puts "saved sober living #{i+1} of #{data.size}"
      sleep 0.2
    end
